...
class Device2:
	...
	def __init__(self, option):
		...
		if self.option== Device2.SAMPLE_DEVICE_ANALOG_DISCOVERY:
			print('connecting to first xANALOG DISCOVERY device')
			self.internal_device = AnalogDiscovery(Device2.SAMPLE_RATE, Device2.BUFFER_SIZE, Device2.SHIFT_SIZE,2)
