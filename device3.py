...
class Device3:
	...
	def __init__(self, option):
		...
		if self.option== Device3.SAMPLE_DEVICE_ANALOG_DISCOVERY:
			print('connecting to first xANALOG DISCOVERY device')
			self.internal_device = AnalogDiscovery(Device3.SAMPLE_RATE, Device3.BUFFER_SIZE, Device3.SHIFT_SIZE,3)
	...
	def calculate_background_fft_profile(self):
		...
		for _ in range (10):
			...
			fft = DSPUtils.calculate_fft(filtered_signal, Device3.BUFFER_SIZE)
