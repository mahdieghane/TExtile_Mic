...
class Device4:
	...
	def __init__(self, option):
		...
		if self.option== Device4.SAMPLE_DEVICE_ANALOG_DISCOVERY:
			print('connecting to first xANALOG DISCOVERY device')
			self.internal_device = AnalogDiscovery(Device4.SAMPLE_RATE, Device4.BUFFER_SIZE, Device4.SHIFT_SIZE,4)
	...
	def calculate_background_fft_profile(self):
		...
		for _ in range (10):
			...
			fft = DSPUtils.calculate_fft(filtered_signal, Device4.BUFFER_SIZE)
